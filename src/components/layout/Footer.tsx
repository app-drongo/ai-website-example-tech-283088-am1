...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Empowering businesses with cutting-edge technology solutions and innovative software development. Trusted by over 10,000 companies worldwide to accelerate their digital transformation.',
  ...
  newsletterDisclaimer:
    'Get exclusive tech insights and product updates. Unsubscribe anytime with one click.',
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Cloud Platform', href: '/cloud', editableId: 'link-footer-cloud' },
        { name: 'AI & Machine Learning', href: '/ai-ml', editableId: 'link-footer-ai' },
        { name: 'Data Analytics', href: '/analytics', editableId: 'link-footer-analytics' },
        { name: 'DevOps Tools', href: '/devops', editableId: 'link-footer-devops' },
        { name: 'API Gateway', href: '/api', editableId: 'link-footer-api' },
        { name: 'Enterprise Security', href: '/security', editableId: 'link-footer-security' },
      ],
    },
    {
      title: config.section2Title,
      links: [
        { name: 'About Example Tech', href: '/about', editableId: 'link-footer-about' },
    ...
    },
    {
      ...
      links: [
        { name: 'Developer Hub', href: '/developers', editableId: 'link-footer-developers' },
        { name: 'Tech Community', href: '/community', editableId: 'link-footer-community' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Data Protection', href: '/data-protection', editableId: 'link-footer-gdpr' },
        {
