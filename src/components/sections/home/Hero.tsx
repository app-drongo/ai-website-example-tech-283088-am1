...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered Development',
  title: 'Ship production-ready apps',
  titleHighlight: '10x faster',
  description:
    'Transform your ideas into scalable applications with our intelligent development platform. Built for modern teams who demand speed without compromising quality.',
  features: [
  ...
  imageAlt: 'Development dashboard interface',
  statsLabel1: 'Deploy Speed',
  statsValue1: '< 30 seconds',
  statsLabel2: 'Developer NPS',
  statsValue2: '94 score',
} as const;
